...
# Defaults to inside the plugin directory unless changed. To change, put the path inside the "", for example: game_list = "G:\\My Games\\GameBoy\\GB-list.txt"
game_list = ""

# .DAT file for lookup. All '\' in path must be doubled.
# Defaults to inside the plugin directory unless changed. To change, put the path inside the "", for example: game_dat = "G:\\My Games\\GameBoy\\GB.dat"
game_dat = ""

# Location of 'installed' local games. All '\' in path must be doubled, and it must end with '\\'
# As an example, it could look like this: roms_path = "G:\\My Games\\GameBoy\\"
